      ...
      >
        ...
        >
          <ProCard>
            <Carousel autoplay>
              <div>
                <img src={banner} style={{ height: '400px', width: '100%' }} />
                {/* <h3 style={contentStyle}>计算机学科知识图谱构建</h3> */}
              </div>
              <div>
                <img src={banner2} style={{height:'400px',width:'100%'}}></img>
              </div>
              <div>
                <img src={banner3} style={{height:'400px',width:'100%'}}></img>
              </div>
              <div>
                <img src={banner4} style={{height:'400px',width:'100%'}}></img>
              </div>
            </Carousel>
          </ProCard>
