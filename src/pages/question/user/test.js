...
class Test extends React.Component {
    ...
    render(){
        ...
        <div style={{width:'400px'}}>
            ...
            <div className='test_item' >
                <ProCard hoverable style={{ marginBlockStart: 8 }}>
                    <div
                      ...
                      style={{fontSize:'medium',whiteSpace:'normal'}}
                    >
            ...
            <div className='test_item'>
                <ProCard hoverable style={{ marginBlockStart: 8 }}>
                    <div className='test_title' style={{fontSize:'medium',whiteSpace:'normal'}}>{this.state.question[2]}</div>
                    <div  style={{ marginBlockStart: 8 }} >
            ...
            <div className='test_item'>
                <ProCard hoverable style={{ marginBlockStart: 8 }}>
                    <div className='test_title' style={{fontSize:'medium',whiteSpace:'normal'}}>{this.state.question[0]}</div>
                    <div  style={{ marginBlockStart: 8 }} >
